...
@Mapper
public interface ArchiveRecipeMapper {
    ...
    RecipeDto toDto(ArchiveRecipe entity);
    ...
    ArchiveRecipe toEntity(RecipeDto dto);

    default List<RecipeDto> toDtos(List<ArchiveRecipe> entities) {
        return entities.stream().map(this::toDto).collect(Collectors.toList());
    }

    default Optional<RecipeDto> toOptionalDto(Optional<ArchiveRecipe> entity) {
